...
class Magmodules_Sooqr_Model_Adminhtml_System_Config_Source_Attribute_Abstract
{
    ...
    public function getAttributesArray()
    {
        ...
        return array(
            'label'         => Mage::helper('sooqr')->__('Atttibutes'),
            'value'         => $optionArray,
            'optgroup-name' => Mage::helper('sooqr')->__('Atttibutes')
        );
    }
    ...
    public function getExtraFields()
    {
        ...
        $optionArray[] = array(
            'label' => Mage::helper('sooqr')->__('Product Type'),
            'value' => 'type_id'
        );
        $optionArray[] = array(
            'label' => Mage::helper('sooqr')->__('Attribute Set ID'),
